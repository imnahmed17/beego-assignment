        ...
        <form class="pt-10">
            <label class="w-full relative block">
                <span class="absolute left-0 top-5">
                    <i class="fi fi-rs-restaurant text-2xl text-slate-500 pl-5"></i>
                </span>
                <input type="text" name="tab2Location" placeholder="Enter a destination or property" class="p-5 w-full rounded-md outline outline-1 outline-slate-300 font-medium placeholder:text-slate-500 pl-16" autocomplete="off">
            </label>
            <div class="mt-6 mb-12 flex items-center gap-4">
                ...
                <div class="px-6 py-1.5 flex rounded-full cursor-pointer hover:bg-[#E9EDF7]">
                    ...
                    <span class="pl-2 text-sm font-medium text-[#265FC9]">Add a restaurant</span>
                </div>
            </div>
